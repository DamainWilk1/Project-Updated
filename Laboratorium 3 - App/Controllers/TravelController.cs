...
namespace Laboratorium_3___App.Controllers
{
    public class TravelController : Controller
    {
        ...
        private List<SelectListItem> CreateTravelAngienciesList()
        {
        ...
        {
            List<SelectListItem> travelAgencies = _travelService.FindAllTravelAgency()
                .Select(e => new SelectListItem()
                {
                    Text = e.Name,
                    Value = e.Id.ToString()
                }).ToList();
            return View(new Travel() { TravelAgenciesList = travelAgencies });
        }
        [HttpPost]
        [Authorize(Roles = "visitor,admin")]
